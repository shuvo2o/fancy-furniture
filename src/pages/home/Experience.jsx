    ...
    return (
        <section className='flex flex-col items-center justify-between gap-8 px-4 mx-auto my-24  section-container max-w-7xl md:flex-row md:gap-20'>
            ...
            <div className='mx-auto md:w-1/2'>
                ...
                <h2 className='text-4xl font-bold capitalize lg:w-1/2'>we provide you the best experience</h2>
                <h4 className='mb-5 text-black lg:w-2/3'>You don’t have to worry about the result because all of these interiors are made by people who are professionals in their fields with an elegant and lucurious style and with premium quality materials</h4>
