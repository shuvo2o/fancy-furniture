    ...
    <section className='px-4 mx-auto section-container max-w-7xl'>
      <div className='grid grid-cols-1 gap-12 my-16 sm:my-24 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8'>
        ...
        <div className='flex items-center justify-center text-3xl font-bold text-center sm:text-left sm:text-4xl sm:justify-start'>
          <h2>Why <br className="hidden sm:block" /> Choosing Us</h2>
        </div>

        {/* Card 1 */}
        <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
          <h3 className='mb-3 text-xl font-semibold md:text-2xl'>Luxury facilities</h3>
        ...
        {/* Card 2 */}
        <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
          <h3 className='mb-3 text-xl font-semibold md:text-2xl'>Affordable Price</h3>
          <p className='mb-4 text-base text-gray-600'>
        ...
        {/* Card 3 */}
        <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
          <h3 className='mb-3 text-xl font-semibold md:text-2xl'>Many Choices</h3>
          <p className='mb-4 text-base text-gray-600'>
